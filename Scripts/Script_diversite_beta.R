...
data_results_beta$Analyse <- "Bray-Curtis"
bray <- ggplot(filter(data_results_beta,cluster != 4))+
  ...
  labs(x="Région",y='Indice de Bray-Curtis')+
  facet_wrap(~Analyse)
  #theme(axis.text.x = element_text(angle = 90, vjust =0.5, hjust = 1, size = 7))

#
# Test difference between region
