...
#### Kolmogorov Smirnov en coupant les données par quinzaine
data <- read_delim("data_modif/Table_FLORTOT_Surf_0722_COM_period_Stselect_hydro_phyto_chloro_phylum_period15_chlafilter_cluster5_div.csv", 
                   delim = ";", escape_double = FALSE, locale = locale(decimal_mark = ",", 
                                                                       grouping_mark = ""), trim_ws = TRUE)
...
datam <- summarise(group_by(Table,Fortnight,cluster), var=mean(TEMP,na.rm=T))
ggplot(datam)+
  geom_line(aes(x=Fortnight,y=var,colour=cluster),size = 1)+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave('TEMP_15.png', path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
...
ggplot(datam)+
  geom_line(aes(x=Fortnight,y=var,colour=cluster),size = 1)+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("SALI_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
...
datam <- summarise(group_by(Table,Fortnight,cluster), var=mean(NH4,na.rm=T))
ggplot(datam)+
  geom_line(aes(x=Fortnight,y=var,colour=cluster),size = 1)+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("NH4_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
...
datam <- summarise(group_by(Table,Fortnight,cluster), var=mean(PO4,na.rm=T))
ggplot(datam)+
  geom_line(aes(x=Fortnight,y=var,colour=cluster),size = 1)+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("PO4_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
...
datam <- summarise(group_by(Table,Fortnight,cluster), var=mean(`TURB-FNU`,na.rm=T))
ggplot(datam)+
  geom_line(aes(x=Fortnight,y=var,colour=cluster),size = 1)+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("TURBFNU_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
...
datam <- summarise(group_by(Table,Fortnight,cluster), var=mean(`NO3+NO2`,na.rm=T))
ggplot(datam)+
  geom_line(aes(x=Fortnight,y=var,colour=cluster),size = 1)+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("NO3NO2_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
...
datam <- summarise(group_by(Table,Fortnight,cluster), var=mean(SIOH,na.rm=T))
ggplot(datam)+
  geom_line(aes(x=Fortnight,y=var,colour=cluster),size = 1)+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("SIOH_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
...
datam <- summarise(group_by(Table,Fortnight,cluster), var=mean(OXYGENE,na.rm=T))
ggplot(datam)+
  geom_line(aes(x=Fortnight,y=var,colour=cluster),size = 1)+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("OXYGENE_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
...
datam <- summarise(group_by(Table,Fortnight,cluster), var=mean(log(CHLOROA+1),na.rm=T))
ggplot(datam)+
  geom_line(aes(x=Fortnight,y=var,colour=cluster),size = 1)+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("CHLOROA_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
...
datam <- summarise(group_by(Table,Fortnight,cluster), var=mean(log(Dinophyceae+1),na.rm=T))
ggplot(datam)+
  geom_line(aes(x=Fortnight,y=var,colour=cluster),size = 1)+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("Dino_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
...
datam <- summarise(group_by(Table,Fortnight,cluster), var=mean(log(Bacillariophyceae+1),na.rm=T))
ggplot(datam)+
  geom_line(aes(x=Fortnight,y=var,colour=cluster),size = 1)+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("Bac_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
...
datam <- summarise(group_by(Table,Fortnight,cluster), var=mean(log(Ciliophora+1),na.rm=T))
ggplot(datam)+
  geom_line(aes(x=Fortnight,y=var,colour=cluster),size = 1)+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("Cilio_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
...
datam <- summarise(group_by(Table,Fortnight,cluster), var=mean(log(Haptophyta +1),na.rm=T))
ggplot(datam)+
  geom_line(aes(x=Fortnight,y=var,colour=cluster),size = 1)+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("Hapt_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
...
datam <- summarise(group_by(Table,Fortnight,cluster), var=mean(log(Cryptophyceae +1),na.rm=T))
ggplot(datam)+
  geom_line(aes(x=Fortnight,y=var,colour=cluster),size = 1)+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("Crypto_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
...
datam <- summarise(group_by(Table,Fortnight,cluster), var=mean(Pielou,na.rm=T))
ggplot(datam)+
  geom_line(aes(x=Fortnight,y=var,colour=cluster),size = 1)+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("Pielou_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
...
datam <- summarise(group_by(Table,Fortnight,cluster), var=mean(Shannon,na.rm=T))
ggplot(datam)+
  geom_line(aes(x=Fortnight,y=var,colour=cluster),size = 1)+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("Shannon_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
...
datam <- summarise(group_by(Table,Fortnight,cluster), var=mean(BergerParker,na.rm=T))
ggplot(datam)+
  geom_line(aes(x=Fortnight,y=var,colour=cluster),size = 1)+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("BergerParker_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
...
datam <- summarise(group_by(Table,Fortnight,cluster), BergerParker=mean(BergerParker,na.rm=T),
                   Shannon=mean(Shannon,na.rm=T),Pielou=mean(Pielou,na.rm=T))
datam <- datam |>
  pivot_longer(cols = c(Shannon, BergerParker, Pielou), names_to = "var", values_to = "val")

ggplot(datam)+
  geom_line(aes(x=Fortnight,y=val,colour=cluster),size = 1)+
  facet_wrap(~var, scale="free")+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("Div_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')


datam <- summarise(group_by(Table,Fortnight,cluster), TEMP=mean(TEMP,na.rm=T),
                   SALI=mean(SALI,na.rm=T),NH4=mean(NH4,na.rm=T),PO4=mean(PO4,na.rm=T),`NO3+NO2`=mean(`NO3+NO2`,na.rm=T),
                   SIOH=mean(SIOH,na.rm=T),OXYGENE=mean(OXYGENE,na.rm=T),`log(CHLOROA+1)`=mean(log(CHLOROA+1),na.rm=T))
datam <- datam |>
  pivot_longer(cols = TEMP:`log(CHLOROA+1)`, names_to = "var", values_to = "val")

ggplot(datam)+
  geom_line(aes(x=Fortnight,y=val,colour=cluster),size = 1)+
  facet_wrap(~var, scale="free")+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("Hydro_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')


datam <- summarise(group_by(Table,Fortnight,cluster),`log(Dinophyceae+1)`=mean(log(Dinophyceae+1),na.rm=T),
                   `log(Bacillariophyceae+1)`=mean(log(Bacillariophyceae+1),na.rm=T),`log(Ciliophora+1)`=mean(log(Ciliophora+1),na.rm=T),
                   `log(Haptophyta+1)`=mean(log(Haptophyta+1),na.rm=T),`log(Cryptophyceae+1)`=mean(log(Cryptophyceae+1),na.rm=T))
datam <- datam |>
  pivot_longer(cols = `log(Dinophyceae+1)`:`log(Cryptophyceae+1)`, names_to = "var", values_to = "val")

ggplot(datam)+
  geom_line(aes(x=Fortnight,y=val,colour=cluster),size = 1)+
  facet_wrap(~var, scale="free")+
  scale_colour_manual(name = 'Cluster', values = cluster_col)
ggsave("Classe_15.png", path = "C:/Users/jeany/OneDrive - etu.sorbonne-universite.fr/Stage ISOMER M2/Projet_R/output/graphs/cluster_description/KS_15aine",dpi = 300, width = 200, height = 160, units = 'mm')
